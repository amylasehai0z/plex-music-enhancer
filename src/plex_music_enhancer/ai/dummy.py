...
DUMMY_SUMMARY_TEXT = (
    "This is a deterministic placeholder summary generated by the DummyProvider "
    "for testing purposes."
)


class DummyProvider(AIProvider):
    """Provider that returns deterministic placeholder summaries without networking."""
